...
function App() {
  ...
  return (
    <>
      ...
      {/* button cart */}
      {!isTab && (
        <section className="fixed top-0 right-2">
          <button
      ...
      {/* Menu bar */}
      <div
        className={`fixed top-0 right-0 transition-transform transform ${
          isTab ? 'translate-x-0' : 'translate-x-full'
        } ease-in-out duration-500`}
      >
        <div
          className={`relative top-0 right-0 h-screen max-w-[1000px] bg-black bg-opacity-90 text-white shadow-lg rounded-lg transition-all duration-500 ease-in-out overflow-hidden`}
        >
